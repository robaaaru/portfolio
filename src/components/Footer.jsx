...
export default function Footer({setPage}){
    ...
    let strokeWidth = 1.8
    const baseClasses = 'stroke-gray-700 hover:stroke-[#048688] lg:w-[1.7rem] lg:h-[2.1rem] w-[1.5rem] h-[1.5rem] hover:-translate-y-1 transition-transform duration-175 ease-in'
