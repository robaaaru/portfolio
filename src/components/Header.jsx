...
export default function Header({ activePage = 0, labels = [], onNavigate }){
    ...
    return(
        <header className="fixed top-0 w-full" style={{ backgroundColor: bgTransparent, color: "var(--foreground)", backdropFilter: "blur(32px)", WebkitBackdropFilter: "blur(32px)", transition: "background-color 200ms ease, color 200ms ease, border-color 200ms ease" }}>
            <div className="mx-auto w-full md:w-[45rem] p-3 md:p-4 h-13 md:h-15 lg:p-5 lg:h-18 border-b overflow-hidden" style={{ borderColor: "var(--border)", transition: "background-color 200ms ease, color 200ms ease, border-color 200ms ease" }}>
